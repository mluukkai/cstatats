...
const translate = (credits = 0) => ({
  en: {
    cred: `Has successfully completed the course's Relational databases part in ${credits} ECTS credits`,
    title: 'Certificate of completion',
    university: 'University lecturer, University of Helsinki',
    company: 'COO, Houston Inc.',
  },
  fi: {
    cred: `On suorittanut kurssin relaatiotietokantoja käsittelevän osan hyväksytysti ${credits} opintopisteen laajuisena`,

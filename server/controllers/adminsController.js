...
const doMangelAkat = async (string, shouldMail) => {
  ...
  if (bad.length > 0) {
    ...
    const mail = `Et ole ilmoittautunut kurssille Akateemiset taidot. Suoritusmerkintää ei voida kirjata ilman ilmoittautumista. Ilmoittaudu seuraavan linkin kautta https://studies.helsinki.fi/kurssit/toteutus/hy-opt-cur-2324-0b19fda1-7ac2-449a-8094-972095a946d6/TKT50004`
